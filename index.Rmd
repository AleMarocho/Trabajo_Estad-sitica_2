...
De igual manera, el siguiente gráfico ilustra los resultados del índice de desigualdad de género empleado a nivel mundial, visibilizando las zonas geográficas más desiguales en cuestiones de género: 
...
modelsummary(model1, title = "Regresión Lineal 4",
             stars = TRUE,
             output = "kableExtra")
```
...
#res =
#data.frame(list("p-value"=res$p.value))%>%
 #   kable(caption = res$method)%>%kable_styling(full_width = F)
```
