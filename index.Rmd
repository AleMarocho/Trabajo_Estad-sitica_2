...
A partir de modelos de regresión lineal, al utilizar las variables índice de desarrollo humano, índice GINI y derechos civiles como variables independientes en un modelo, este tiene mayor significancia en la variable dependiente. Esto se debe a que cuenta con un 75.1% de capacidad explicativa. De igual manera, la regresión lineal múltiple que considera todas las variables independientes tiene un 80.5% de significancia, convirtiéndose en el mejor modelo de todos los elaborados. No obstante, variables tales como el índice de militarización global o de derechos civiles terminan por no aportar al modelo, teniendo a su vez un efecto bajo. 
...
Finalmente, a través de un análisis de conglomerados se hizo uso de varias técnicas para elaborar subconjuntos por medio de las variables independientes. Realizamos un gráfico con los tres clusters divididos según las variables independientes a través del algoritmo DIANA. Este gráfico nos ayudó a visualizar a nivel mundial los resultados del análisis de conglomerados.
